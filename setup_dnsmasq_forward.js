...
conn.on('ready', () => {
    ...
    const cmds = [
        'echo satdes2155 | sudo -S mkdir -p /etc/NetworkManager/dnsmasq-shared.d',
        'echo satdes2155 | sudo -S sh -c "echo \\"server=127.0.0.1#5300\\" > /etc/NetworkManager/dnsmasq-shared.d/adguard.conf"',
